...
$(function(){
    ...
    /*---------------------- Main menu With drop down -----------------------*/
        ...
        //Header Search
        $(".header__search, .close__search").click(function(){
			$(".search__box").stop(true, true).toggleClass("open");
			$(this).toggleClass("active");
		});
		$('body').click(function () {
			$('.header__search, .close__search').removeClass("active");
			$('.search__box').removeClass("open");
		});
		$('.header__search, .search__box, .close__search').click(function (event) {
			event.stopPropagation();
		});


        $('.grantees__carosel.owl-carousel').owlCarousel({
            items:1,
            loop:true,
            center:false,
            margin:0,
            autoplay:true,
            nav: true,
            navText: ["<span class='icon-arrow-5'></span>","<span class='icon-arrow-5'></span>"],
            dots:false,
            responsive:{
                0:{
                    items:1
        ...
        $('.customers-saying .owl-carousel').owlCarousel({
            items:1,
            loop:true,
            center:false,
            margin:15,
        ...
        $(".grantees__next--prev.prev").click(function(){
            $(".grantees__main .owl-prev").trigger('click');	 
        });
        $(".grantees__next--prev.next").click(function(){
            $(".grantees__main .owl-next").trigger('click'); 
        });
		...
		$('.search__btn, .search__box').click(function (event) {
			event.stopPropagation();
		});
        ...
        */
        ...
        //*------------------ Sub-banners -----------------*/
        function makeBg(){
            $(".set__as--bg").each(function(){
                var imgurl = $(this).find("> span.make__bg img").attr('src');
...
$(window).scroll(function() {    
    var scroll = $(window).scrollTop();
     ...
     //>=, not <=
    if (scroll >= 200) {
        $(".floating-cta").addClass("is-revealed");
    }
    else{
        $('.floating-cta').removeClass("is-revealed");
    }
});
...
$('body').click(function () {
    $('.menu-toggle2').removeClass("active");
    $('.header__hamburger--dropdown').removeClass("expand");
});
$('.menu-toggle2, .header__hamburger--dropdown').click(function (event) {
    event.stopPropagation();
});

function hamBerger(){
    $(".header__hamburger--dropdown > li").find("> ul").parent().addClass("dropdown");

    var allAccordion1 = $('.header__hamburger--dropdown > li > ul');
    var allAccordionItem1 = $('.header__hamburger--dropdown > li.dropdown > a');
    $(allAccordionItem1).click(function () {
